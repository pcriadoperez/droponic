...
if( isset($_POST) ){
    ...
    //validate message is greater than 2 characters
    elseif(strlen($message) < 2){
        $formok = false;
        $errors[] = "Your message must be greater than 2 characters";
    }
     
    //send email if all is ok
    if($formok){
        $headers = "From: site@droponic.com" . "\r\n";
        ...
        mail("pablo@droponic.com","Droponic Website contact",$emailbody,$headers);
